...
<div x-data="{ openIndex: null }" class="w-3/4 mx-auto my-8">
    <h1 class="text-4xl font-bold text-gray-600 text-center mb-8">الأسئلة الشائعة</h1>
    @foreach($questions as $index => $question)
    <div class="bg-gray-100 rounded-lg border border-gray-200 mb-4">
