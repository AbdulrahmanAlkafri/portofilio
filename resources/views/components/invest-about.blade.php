<div class="py-10 bg-gray-50">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-6 text-right">
            <h2 class="text-4xl font-bold mb-6 text-gray-600"
            ...
            <p class="text-3xl tracking-wide leading-relaxed"
        ...
        <!-- Left Section for Cards and Images -->
        <div class="space-y-4">
            <!-- Stats Cards -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between">
                    ...
                    <div class="flex flex-col text-right items-baseline">
                        <span class="text-3xl font-bold text-orange-500">11</span>
                        <span class="text-green-500 ml-2 text-2xl">2% ↑</span>
                    </div>
                    <img src="{{asset("images/invest-home/invest-home1.png")}}" loading="lazy" />
                </div>
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between gap-y-4">
                ...
                <div class="flex justify-between items-center">
                    <div class="flex flex-col items-baseline">
                        <span class="text-3xl font-bold text-orange-500 mx-2">$682.5</span>
                        <span class="text-gray-500 ml-2" data-en="On the right track" data-ar="على المسار الصحيح">على
                            المسار
                            الصحيح
                            <span>
                                <svg width="15" height="16" viewBox="0 0 15 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <rect y="0.5" width="15" height="15" rx="7.5" fill="#676767" />
                                    <g clip-path="url(#clip0_15_5580)">
                                        <path
                                            d="M6.12501 9.92498L4.52085 8.32081C4.3421 8.14206 4.05793 8.14206 3.87918 8.32081C3.70043 8.49956 3.70043 8.78373 3.87918 8.96248L5.7996 10.8829C5.97835 11.0616 6.2671 11.0616 6.44585 10.8829L11.3042 6.02915C11.4829 5.8504 11.4829 5.56623 11.3042 5.38748C11.1254 5.20873 10.8413 5.20873 10.6625 5.38748L6.12501 9.92498Z"
                                            fill="white" />
                                    </g>
                                    <defs>
                                        <clipPath id="clip0_15_5580">
                                            <rect width="11" height="11" fill="white" transform="translate(2 2.5)" />
                                        </clipPath>
                                    </defs>
                                </svg>
                    ...
                    <p class="text-green-500 text-3xl font-bold" data-en="+2.45%" data-ar="+2.45%">+2.45%</p>
                </div>
                <img class="w-fit" src="{{asset("images/invest-home/invest-home3.png")}}" />
            </div>
        </div>
